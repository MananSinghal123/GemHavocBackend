...
exports.getTokenByTokenAddress = exports.getTokenByTokenName = exports.tokensList = void 0;
exports.tokensList = [
    {
        name: "USDt",
...
const getTokenByTokenName = (name) => {
    const token = exports.tokensList.find((token) => token.name.toLowerCase() === name.toLowerCase() || token.name.toLowerCase().includes(name.toLowerCase()));
    return token;
};
exports.getTokenByTokenName = getTokenByTokenName;
const getTokenByTokenAddress = (address) => {
    const token = exports.tokensList.find((token) => token.tokenAddress.toLowerCase() === address.toLowerCase());
    return token;
};
