...
exports.ThalaRedeemMODTool = void 0;
const ts_sdk_1 = require("@aptos-labs/ts-sdk");
const tools_1 = require("langchain/tools");
const utils_1 = require("../../utils");
class ThalaRedeemMODTool extends tools_1.Tool {
    constructor(agent) {
        super();
        this.agent = agent;
        this.name = "thala_redeem_mod";
        this.description = `this tool can be used to redeem move dollar (MOD) in Thala
  ...
  Only supported coin types: lzUSDC, whUSDC, or USDt
    ...
    async _call(input) {
        try {
            ...
            const redeemMODTransactionHash = await this.agent.redeemMODWithThala(parsedInput.mintType, (0, ts_sdk_1.convertAmountFromHumanReadableToOnChain)(parsedInput.amount, 6));
...
exports.ThalaRedeemMODTool = ThalaRedeemMODTool;
