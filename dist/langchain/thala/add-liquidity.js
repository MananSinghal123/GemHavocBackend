...
exports.ThalaAddLiquidityTool = void 0;
const ts_sdk_1 = require("@aptos-labs/ts-sdk");
const tools_1 = require("langchain/tools");
const utils_1 = require("../../utils");
class ThalaAddLiquidityTool extends tools_1.Tool {
    constructor(agent) {
        super();
        this.agent = agent;
        this.name = "thala_add_liquidity";
        this.description = `this tool can be used to add liquidity to a Thala pool
    ...
    async _call(input) {
        try {
            ...
            const addLiquidityTransactionHash = await this.agent.addLiquidityWithThala(parsedInput.mintX, parsedInput.mintY, (0, ts_sdk_1.convertAmountFromHumanReadableToOnChain)(parsedInput.mintXAmount, mintXDetail.decimals), (0, ts_sdk_1.convertAmountFromHumanReadableToOnChain)(parsedInput.mintYAmount, mintYDetail.decimals));
...
exports.ThalaAddLiquidityTool = ThalaAddLiquidityTool;
