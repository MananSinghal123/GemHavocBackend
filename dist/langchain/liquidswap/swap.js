...
exports.LiquidSwapSwapTool = void 0;
const ts_sdk_1 = require("@aptos-labs/ts-sdk");
const tools_1 = require("langchain/tools");
const __1 = require("../..");
const get_pool_address_by_token_name_1 = require("../../utils/get-pool-address-by-token-name");
class LiquidSwapSwapTool extends tools_1.Tool {
    constructor(agent) {
        super();
        this.agent = agent;
        this.name = "liquidswap_swap";
        this.description = `this tool can be used to swap tokens in liquidswap
...
minCoinOut: number, eg 1 or 0.01 (optional)`;
    ...
    async _call(input) {
        try {
            ...
            const swapTransactionHash = await this.agent.swap(mintX, mintY, (0, ts_sdk_1.convertAmountFromHumanReadableToOnChain)(parsedInput.swapAmount, mintXDetail.decimals), (0, ts_sdk_1.convertAmountFromHumanReadableToOnChain)(parsedInput.minCoinOut, mintXDetail.decimals) || 0);
...
exports.LiquidSwapSwapTool = LiquidSwapSwapTool;
