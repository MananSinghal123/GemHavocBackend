...
exports.EchelonLendTokenTool = void 0;
const ts_sdk_1 = require("@aptos-labs/ts-sdk");
const tools_1 = require("langchain/tools");
const __1 = require("../..");
const get_pool_address_by_token_name_1 = require("../../utils/get-pool-address-by-token-name");
class EchelonLendTokenTool extends tools_1.Tool {
    constructor(agent) {
        super();
        this.agent = agent;
        this.name = "echelon_lend_token";
    ...
    async _call(input) {
        try {
            ...
            const lendTokenTransactionHash = await this.agent.lendTokenWithEchelon(token.tokenAddress, (0, ts_sdk_1.convertAmountFromHumanReadableToOnChain)(parsedInput.amount, mintDetail.decimals || 8), token.poolAddress, token.tokenAddress.split("::").length !== 3);
...
exports.EchelonLendTokenTool = EchelonLendTokenTool;
