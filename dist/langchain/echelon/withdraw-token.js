...
exports.EchelonWithdrawTokenTool = void 0;
const ts_sdk_1 = require("@aptos-labs/ts-sdk");
const tools_1 = require("langchain/tools");
const __1 = require("../..");
const get_pool_address_by_token_name_1 = require("../../utils/get-pool-address-by-token-name");
class EchelonWithdrawTokenTool extends tools_1.Tool {
    constructor(agent) {
        super();
        this.agent = agent;
        this.name = "echelon_withdraw_token";
        this.description = `this tool can be used to withdraw APT, tokens or fungible asset from a position
    ...
    async _call(input) {
        try {
            ...
            const withdrawTokenTransactionHash = await this.agent.withdrawTokenWithEchelon(token.tokenAddress, (0, ts_sdk_1.convertAmountFromHumanReadableToOnChain)(parsedInput.amount, mintDetail.decimals || 8), token.poolAddress, token.tokenAddress.split("::").length !== 3);
...
exports.EchelonWithdrawTokenTool = EchelonWithdrawTokenTool;
