...
exports.JouleWithdrawTokenTool = void 0;
const ts_sdk_1 = require("@aptos-labs/ts-sdk");
const tools_1 = require("langchain/tools");
const __1 = require("../..");
class JouleWithdrawTokenTool extends tools_1.Tool {
    constructor(agent) {
        super();
        this.agent = agent;
        this.name = "joule_withdraw_token";
  ...
  `;
    ...
    async _call(input) {
        try {
            ...
            const withdrawTokenTransactionHash = await this.agent.withdrawToken((0, ts_sdk_1.convertAmountFromHumanReadableToOnChain)(parsedInput.amount, mintDetail.decimals || 8), parsedInput.mint, parsedInput.positionId, fungibleAsset);
...
exports.JouleWithdrawTokenTool = JouleWithdrawTokenTool;
